...
export const researchEngines: ResearchEngine[] = [
  ...
  },
  {
    ...
    supportedObservableIds: ["OBS-RULE-CENTROID-DISPLACEMENT", "OBS-POSTSHOCK-RULE-DISPLACEMENT", "OBS-BOTTLENECK-DEPTH", "OBS-RULE-DIVERSITY", "OBS-RULE-PATH-LENGTH", "OBS-POPULATION-RECOVERY", "OBS-LINEAGE-DIVERSITY", "OBS-LINEAGE-REWEIGHTING-SHARE", "OBS-LINEAGE-DIRECTIONAL-COHERENCE", "OBS-CUMULATIVE-LINEAGE-TURNOVER", "OBS-REWEIGHTING-PATH-TORTUOSITY"],
    supportedExperimentIds: ["RUL-020", "RUL-021", "RUL-025", "RUL-026"],
