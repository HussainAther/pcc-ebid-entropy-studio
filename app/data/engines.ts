...
export const researchEngines: ResearchEngine[] = [
  ...
  },
  {
    ...
    status: "validated",
    deterministic: false,
    entrypoints: [{ id: "EP-RULIAL-ALIFE", label: "Run RUL-020 mutable-rule ALife pilot", command: "python3 scripts/run-rulial-alife.py --output-dir data/ruliology/alife-rule-motion", protocol: "python-module", description: "Executes matched stable, scarcity-mutable, and scarcity-frozen ecological conditions across frozen seeds." }],
    supportedObservableIds: ["OBS-RULE-CENTROID-DISPLACEMENT", "OBS-RULE-DIVERSITY", "OBS-RULE-PATH-LENGTH", "OBS-POPULATION-RECOVERY", "OBS-LINEAGE-DIVERSITY"],
    supportedExperimentIds: ["RUL-020"],
    artifactSchemaVersion: "entropy-rulial-alife-motion/1.0.0",
    projectId,
  },
  {
