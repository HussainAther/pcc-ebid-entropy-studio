globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/studio-CO2z9UsV.js","assets/layout-segment-context-CIE-hUXd.js"];
...
function getDraftSecret() {
	return "920c781e-bf4b-4685-8ab3-77549dffa041";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "edb48cd2-1cea-4dd5-94da-a2993e42681f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "edb48cd2-1cea-4dd5-94da-a2993e42681f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "edb48cd2-1cea-4dd5-94da-a2993e42681f",
		rootBoundaryId
	});
}
/**
...
var metadata = {
	title: "PCC / EBID Research Studio",
	description: "An exploratory computational laboratory for structured instability, adaptation, and information dynamics.",
